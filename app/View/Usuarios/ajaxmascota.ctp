...
<?php echo $this->Form->create('Usuario',array('action' => 'guardamascota/'.$idMascota.'/'.$generacion.'/'.$tpadre,'id' => 'mascotaform'));?>
			...
			<div class="widget widget-heading-simple widget-body-gray" data-toggle="collapse-widget">
				<div class="widget-body">
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <h5>Raza</h5>
                                            <?php echo $this->Form->select('Mascota.raza_id',$razas,array('class' => 'span12','required','disabled'));?>
                                        </div>
                                    </div>
                                    <div class="row-fluid">
                                        <div class="span6">
                                            ...
                                            <?php echo $this->Form->select('Mascota.sexo', $dcs, array('class' => 'span12','required','disabled'));?>
                                        </div>
                                        <div class="span6">
                                            <h5>Codigo</h5>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <div class="span6">
                                                <a href="javascript:" class="btn btn-inverse span12 boton" onclick="$('#imgcargando').toggle();$('#mimodal').toggle();$('#mimodal').load('<?php echo $this->Html->url(array('controller' => 'Mascotas','action' => 'ajaxpadre',$idMascota,$generacion));?>',function(){$('#imgcargando').toggle(100);$('#mimodal').toggle();});">Cancelar</a>
                                            </div>
                                            <div class="span6">
  ...
  $("#mascotaform").submit(function(e)
{
    ...
    $.ajax(
    {
        ...
        complete:function (XMLHttpRequest, textStatus) {
           $('#imgcargando').toggle(100);$('#mimodal').toggle();
        },
