...
<div style="margin-top: -10px; margin-left: -8px; width: 1135px; height: 735px;background-repeat: no-repeat; background-size: 1137px 742px; background-image: url('<?php echo $this->Html->webroot('img/PEDIGREE KENNEL CLUB FINALES-02.jpg')?>'); border-top: 1px solid blue; border-bottom: 1px solid blue; border-left: 1px solid blue; border-right: 1px solid blue; font-family: Arial;">
    <div id="certificado" style="padding-top: 46px;">
        ...
        <table style="width: 980px; height: 17px; border-spacing: 0px; color: #124996; font-size: 13px; font-weight: bold; ">
            ...
            <td style="width: 80px;"></td>
            <td style="width: 90px; ">
                <div id="divsexo" style="width: 90px; height: 16;">
                    <span id="spansexo">
            ...
            <div id="divfechanac" style="width: 147px; height: 16px;">
            ...
            <td style="width: 132px;">
                <div id="divconsanguinidad" style="width: 130px; height: 16px;">
        ...
        <table style=" width: 980px; font-size: 11px; border-spacing: 0px; color: #124996; font-weight: bold;">
            ...
            <td style="width: 80px;"></td>
            <td style="width: 90px;">
                <div id="divkcb" style="width: 90px; height: 15px;">
                    <span id="spankcb">
            ...
            <td style="width: 147px; ">
                <div id="divtatuaje" style="width: 145px; height: 15px;">
                    <span id="spantatuaje">
            ...
            <td style="width: 130px;">
                <div id="divmicrochip" style="width: 129px; height: 15px;">
        ...
        <div style="width: 1082px; height: 432px; margin-left: 30px; margin-top: 21px;">
            <table style="width: 1080px; height: 216px; padding: 0px; border-spacing: 0px; color: #124996; font-size: 9px; font-weight: bold;">
                  ...
                  <tr style="">
                    ...
                    <div id="divuno" style="width: 190px; height: 170px; margin-left: 30px;">
                    <span id="spanuno">
                   ...
                   <?php if(!empty($padre[1]['Mascota']['num_tatuaje'])){echo 'No. x Raza '.$padre[1]['Mascota']['num_tatuaje'].'<br />';}?>                   
                    ...
                    <?php if(!empty($padre[1]['apto_reproduccion'])){echo 'Apto de Reproduccion <br />'.$padre[1]['apto_reproduccion']['Examenesmascota']['resultado'].' ('.$padre[1]['apto_reproduccion']['Examenesmascota']['observacion'].') <br />';}?>
                    <?php if(!empty($padre[1]['Mascota']['color'])){echo 'Color: '.$padre[1]['Mascota']['color'].'';}?>
                    <?php endif;?>
                    </span>
                    </div>
                   ...
                   <?php //if(!empty($padre[3]['Mascota']['num_tatuaje'])){echo 'No. x Raza '.$padre[3]['Mascota']['num_tatuaje'].'<br />';}?>                   
                    ...
                    <?php if(!empty($padre[3]['apto_reproduccion'])){echo 'Apto de Reproduccion <br />'.$padre[3]['apto_reproduccion']['Examenesmascota']['resultado'].' ('.$padre[3]['apto_reproduccion']['Examenesmascota']['observacion'].') <br />';}?>
                    <?php if(!empty($padre[3]['Mascota']['color'])){echo ' '.$padre[3]['Mascota']['color'].'';}?>
                    ...
                    <span style="color: red;">
                    <?php if(!empty($padre[7]['titulos'])){echo strtoupper($padre[7]['titulos']).'<br/>';}?>
                    </span>
                    <?php echo $padre[7]['Mascota']['nombre_completo'];?><br />
                  ...
                  <tr>
                    ...
                    <span style="color: red;">
                    <?php if(!empty($padre[8]['titulos'])){echo strtoupper($padre[8]['titulos']).'<br/>';}?>
                    </span>
                    <?php echo $padre[8]['Mascota']['nombre_completo'];?><br />
                  ...
                  <tr>
                   ...
                   <?php //if(!empty($padre[4]['Mascota']['num_tatuaje'])){echo 'No. x Raza '.$padre[4]['Mascota']['num_tatuaje'].'<br />';}?>                   
                    ...
                    <?php if(!empty($padre[4]['apto_reproduccion'])){echo 'Apto de Reproduccion <br />'.$padre[4]['apto_reproduccion']['Examenesmascota']['resultado'].' ('.$padre[4]['apto_reproduccion']['Examenesmascota']['observacion'].') <br />';}?>
                    <?php if(!empty($padre[4]['Mascota']['color'])){echo ' '.$padre[4]['Mascota']['color'].'';}?>
                    ...
                    <span style="color: red;">
                    <?php if(!empty($padre[9]['titulos'])){echo strtoupper($padre[9]['titulos']).'<br/>';}?>
                    </span>
                    <?php echo $padre[9]['Mascota']['nombre_completo'];?><br />
                  ...
                  <tr>
                    ...
                    <span style="color: red;">
                    <?php if(!empty($padre[10]['titulos'])){echo strtoupper($padre[10]['titulos']).'<br/>';}?>
                    </span>
                    <?php echo $padre[10]['Mascota']['nombre_completo'];?><br />
            ...
            <tr>
                    <td rowspan="8" style="width: 246px; height: 216px; ">
                    <div id="divdos" style="width: 190px; height: 170px; margin-left: 30px;">
                    <span id="spandos">
                   ...
                   <?php if(!empty($padre[2]['Mascota']['num_tatuaje'])){echo 'No. x Raza '.$padre[2]['Mascota']['num_tatuaje'].'<br />';}?>                   
                    ...
                    <?php if(!empty($padre[2]['apto_reproduccion'])){echo 'Apto de Reproduccion <br />'.$padre[2]['apto_reproduccion']['Examenesmascota']['resultado'].' ('.$padre[2]['apto_reproduccion']['Examenesmascota']['observacion'].') <br />';}?>
                    <?php if(!empty($padre[2]['Mascota']['color'])){echo 'Color: '.$padre[2]['Mascota']['color'].'';}?>
                   ...
                   <?php //if(!empty($padre[5]['Mascota']['num_tatuaje'])){echo 'No. x Raza '.$padre[5]['Mascota']['num_tatuaje'].'<br />';}?>                   
                    ...
                    <?php if(!empty($padre[5]['apto_reproduccion'])){echo 'Apto de Reproduccion <br />'.$padre[5]['apto_reproduccion']['Examenesmascota']['resultado'].' ('.$padre[5]['apto_reproduccion']['Examenesmascota']['observacion'].') <br />';}?>
                    <?php if(!empty($padre[5]['Mascota']['color'])){echo ' '.$padre[5]['Mascota']['color'].'';}?>
                    ...
                    <span style="color: red;">
                    <?php if(!empty($padre[11]['titulos'])){echo strtoupper($padre[11]['titulos']).'<br/>';}?>
                    </span>
                    <?php echo $padre[11]['Mascota']['nombre_completo'];?><br />
                  ...
                  <tr>
                    ...
                    <span style="color: red;">
                    <?php if(!empty($padre[12]['titulos'])){echo strtoupper($padre[12]['titulos']).'<br/>';}?>
                    </span>
                    <?php echo $padre[12]['Mascota']['nombre_completo'];?><br />
                  ...
                  <tr>
                   ...
                   <?php //if(!empty($padre[6]['Mascota']['num_tatuaje'])){echo 'No. x Raza '.$padre[6]['Mascota']['num_tatuaje'].'<br />';}?>                   
                    ...
                    <?php if(!empty($padre[6]['apto_reproduccion'])){echo 'Apto de Reproduccion <br />'.$padre[6]['apto_reproduccion']['Examenesmascota']['resultado'].' ('.$padre[6]['apto_reproduccion']['Examenesmascota']['observacion'].') <br />';}?>
                    <?php if(!empty($padre[6]['Mascota']['color'])){echo ' '.$padre[6]['Mascota']['color'].'';}?>
                    ...
                    <span style="color: red;">
                    <?php if(!empty($padre[13]['titulos'])){echo strtoupper($padre[13]['titulos']).'<br/>';}?>
                    </span>
                    <?php echo $padre[13]['Mascota']['nombre_completo'];?><br />
                   ...
                   <?php //if(!empty($padre[14]['Mascota']['num_tatuaje'])){echo 'No. x Raza '.$padre[14]['Mascota']['num_tatuaje'].'<br />';}?>                   
                    ...
                    <?php if(!empty($padre[13]['apto_reproduccion'])){echo 'Apto de Reproduccion '.$padre[13]['apto_reproduccion']['Examenesmascota']['resultado'].' ('.$padre[13]['apto_reproduccion']['Examenesmascota']['observacion'].') ';}?>
                    <?php if(!empty($padre[13]['Mascota']['color'])){echo ' '.$padre[13]['Mascota']['color'].'';}?>
                  ...
                  <tr>
                    ...
                    <span style="color: red;">
                    <?php if(!empty($padre[14]['titulos'])){echo strtoupper($padre[14]['titulos']).'<br/>';}?>
                    </span>
                    <?php echo $padre[14]['Mascota']['nombre_completo'];?><br />
                   ...
                   <?php //if(!empty($padre[14]['Mascota']['num_tatuaje'])){echo 'No. x Raza '.$padre[14]['Mascota']['num_tatuaje'].'<br />';}?>                   
                    <?php //if(!empty($padre[14]['Mascota']['chip'])){echo 'Chip '.$padre[14]['Mascota']['chip'].'<br />';}?>
                    <?php if(!empty($padre[14]['apto_reproduccion'])){echo 'Apto de Reproduccion '.$padre[14]['apto_reproduccion']['Examenesmascota']['resultado'].' ('.$padre[14]['apto_reproduccion']['Examenesmascota']['observacion'].') ';}?>
                    <?php if(!empty($padre[14]['Mascota']['color'])){echo ' '.$padre[14]['Mascota']['color'].'';}?>
...
$(document).ready(function() {
    ...
    autosize("spanuno","divuno",22);
    autosize("spandos","divdos",22);
