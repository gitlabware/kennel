                ...
                <div class="widget-body">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <div class="span6">
                                <?php echo $this->Form->checkbox("verificado")?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="divselectpadre">
                        ...
                        <div id="divselectpadreajax">
                            <a href="#modalsel" data-toggle="modal" class="btn btn-block btn-primary" onclick="$('#modalsele').load('<?php echo $this->Html->url(array('controller' => 'Mascotas', 'action' => 'combomascotas1', 'Mascota.reproductor_id', 'divselectpadreajax')); ?>');"> <?php
                                if (!empty($this->request->data['Reproductor']['nombre_completo'])) {
                    ...
                    <div id="divselectmadre">
                        ...
                        <div id="divselectmadreajax">
                            <a href="#modalsel" data-toggle="modal" class="btn btn-block btn-primary" onclick="$('#modalsele').load('<?php echo $this->Html->url(array('controller' => 'Mascotas', 'action' => 'combomascotas1', 'Mascota.reproductora_id', 'divselectmadreajax')); ?>');"> <?php
                                if (!empty($this->request->data['Reproductora']['nombre_completo'])) {
                    ...
                    <div id="divselectprop">
                        ...
                        <div id="divselectpropajax">
                            <a href="#modalsel" data-toggle="modal" class="btn btn-block btn-primary" onclick="$('#modalsele').load('<?php echo $this->Html->url(array('controller' => 'Propietarios', 'action' => 'combo1', 'Mascota.propietarioactual_id', 'divselectpropajax')); ?>');"><?php
                                if (!empty($this->request->data['Propietarioactual']['nombre'])) {
...
<?php echo $this->Form->hidden('criadero_id'); ?>
                                    <a href="#modalsel" data-toggle="modal" class="btn btn-block btn-primary" onclick="$('#modalsele').load('<?php echo $this->Html->url(array('controller' => 'Criaderos', 'action' => 'combo1', 'Mascota.criadero_id', 'divselectcriaajax')); ?>');"><?php
