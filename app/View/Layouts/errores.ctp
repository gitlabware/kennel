...
<head>
	<title>Quick Admin Template (v1.3.3)</title>
	...
	<link href="<?php echo $this->webroot;?>common/theme/css/style-flat.css?1372280981" rel="stylesheet" type="text/css" />
...
<!-- // Themer END -->
	...
	<!-- Common Demo Script -->
	<script src="<?php echo $this->webroot;?>common/theme/scripts/demo/common.js?1372280981"></script>
