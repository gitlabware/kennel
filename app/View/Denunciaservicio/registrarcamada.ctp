                ...
                <div id="sheepItForm">
                    ...
                    <div id="sheepItForm_template">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                <div class="span4">
                                    <label for="sheepItForm_#index#_chip">Chip <span id="sheepItForm_label"></span></label>
                                    <?php echo $this->Form->text("Mascota.#index#.chip", array('id' => "sheepItForm_#index#_chip", 'class' => 'span12')); ?>
                                </div>
                                <div class="span8">
                                    <label for="sheepItForm_#index#_hermanos">Hermanos <span id="sheepItForm_label"></span></label>
                                    <?php echo $this->Form->text("Mascota.#index#.hermano", array('id' => "sheepItForm_#index#_hernamos", 'class' => 'span12')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <?php foreach ($leemascotas as $le): ?>
                            <div class="span4">
                                <a href="#myModal" data-toggle="modal" class="label label-info span12 center" onclick="$('#imgcargando').toggle();
                                        $('#mimodal').toggle();
                                        $('#mimodal').load('<?php echo $this->Html->url(array('controller' => 'Mascotas', 'action' => 'ajaxmascota', $le['Mascota']['id'])); ?>', function () {
                                            $('#imgcargando').toggle(100);
                                            $('#mimodal').toggle();
                                        });"><?php echo $le['Mascota']['nombre'] ?></a>
                            </div>
    <?php endforeach; ?>
                    </div>
                </div>
...
<script>
                            ...
                            function paga(aux)
                            {
                                $('#imgcargando').toggle();
                                $('#mimodal').toggle();
                                $('#mimodal').load('<?php echo $this->Html->url(array('controller' => 'Cuentas', 'action' => 'ajaxpagoservicio', $idIngreso)); ?>/' + aux + '/0', function () {
                                    $('#imgcargando').toggle(100);
                                    $('#mimodal').toggle();
                                });
                            }
