...
?>
<div class="innerLR">
<h3 class="center">RANKING OFICIAL CACHORROS ABSOLUTOS DE <?php if(!empty($ano)){echo $ano;}else{echo strtoupper($evento['Evento']['nombre']); }?></h3>
<h3 class="center">KENNEL CLUB BOLIVIANO</h3>
    <div class="widget widget-heading-simple widget-body-gray">
        ...
        <table class="table table-bordered table-white">
            ...
            if(!empty($ano))
            {
                $ranking = $evenmaspun->find('all',array('recursive' => 2,'order' => 'EventosMascotasPuntaje.puntos ASC','conditions' => array('EventosMascotasPuntaje.raza_id' => $ra['Raza']['id'],'Year(Evento.fecha_inicio)' => $ano,'EventosMascotasPuntaje.categoriaspista_id' => 2)));
            }
            else{
                $ranking = $evenmaspun->find('all',array('recursive' => 2,'order' => 'EventosMascotasPuntaje.puntos ASC','conditions' => array('EventosMascotasPuntaje.raza_id' => $ra['Raza']['id'],'EventosMascotasPuntaje.evento_id' => $idEvento,'EventosMascotasPuntaje.categoriaspista_id' => 2)));
            }
