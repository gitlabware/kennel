        ...
        for($i = 1;$i <= 30;$i++)
        {
            ...
            if(($i % 2) == 0)
            {
                if(!empty($padre[$j]['Mascota']['reproductora_id']))
                {
                    ...
                    ,'fields' => array('Mascota.id','Mascota.nombre_completo','Mascota.reproductor_id','Mascota.reproductora_id','Mascota.kcb','Mascota.num_tatuaje','Mascota.chip','Mascota.color','Mascota.codigo','Mascota.titulos_ex')
                    ));
                    ...
                    if(!empty($padre[$i]['Mascota']['titulos_ex']))
                    {
                        ...
                        $var_titulos = $padre[$i]['Mascota']['titulos_ex'];
                    }
                    if(!empty($titulos))
                    {
                        foreach($titulos as $ti)
